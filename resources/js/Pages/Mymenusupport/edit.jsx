     ...
     const swithingredient = () =>{
        ...
        <div>
            ...
            <input type="button" onClick={() => {
                setData("ingredient_quantity",ingredients);
                setIngrededit(false);
            }} value="食材を確定する" className="p-1 bg-purple-300 hover:bg-purple-400 rounded-md"/>
            {renderOptions()}
            ...
            <div>
                {console.log(data)}
                <div>
                    <input type="button" onClick={() =>  setIngrededit(true)} value="食材を入れなおす" className="p-1 bg-purple-300 hover:bg-purple-400 rounded-md"/>
                </div>
